          ...
          >
            <input
              ...
              onInput={(e) =>
                chatStore.updateTargetSession(
                  session,
                  (session: ChatSession) => (session.topic = e.currentTarget.value),
                )
              }
            ></input>
          </ListItem>
...
function _Chat() {
  ...
  const showMaxIcon = !isMobileScreen && false; // !clientConfig?.isApp;
  ...
  const handlePaste = useCallback(
    async (event: React.ClipboardEvent<HTMLTextAreaElement>) => {
      ...
      const items = (event.clipboardData || window.ClipboardItem.toString).items;
