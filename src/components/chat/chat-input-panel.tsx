              ...
              >
                {file.uploadStatus === 'uploading' && (
                  <div className={styles["file-status-overlay"]}>
                    <FileCircularProgress progress={file.uploadProgress || 0} />
                  </div>
                )}
                ...
                {isImage ? (
                  <div className={styles["attach-file-mask-image"]}>
                    <ActionButton
                      icon={<img src="/icons/delete.svg" className={styles.deleteAttachmentIcon} alt="Delete attached image" />}
        ...
        <div className={styles["chat-input-controls-left"]}>
          ...
          >
            <span className={styles['search-button-icon']}>
              <img src="/icons/search.svg" alt="Search" className={styles.inputActionIcon} />
            </span>
