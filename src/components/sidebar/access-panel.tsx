  ...
  return (
    <div className="w-full flex flex-col items-start inline-flex">
      <div className="w-[376px] flex flex-col justify-start items-start gap-1.5">
        <div className="flex justify-center flex-col text-[#979797] text-base font-sans font-normal break-words">Access</div>
      </div>
      <div 
      ...
      >
        ...
        <div className="w-[292px] flex justify-center flex-col text-[#1E1E1E] text-base font-sans font-medium break-words">Lock Panda</div>
      </div>
    </div>
  );
};
